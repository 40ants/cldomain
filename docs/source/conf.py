# -*- coding: utf-8 -*-
#
# sphinxcontrib.cldomain documentation build configuration file, created by
...
project = u'sphinxcontrib.cldomain'
copyright = u'2017, '
...
htmlhelp_basename = 'sphinxcontrib.cldomaindoc'
...
latex_documents = [
  ('index', 'sphinxcontrib.cldomain.tex', u'sphinxcontrib.cldomain Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'sphinxcontrib.cldomain', u'sphinxcontrib.cldomain Documentation',
     [u''], 1)
]
